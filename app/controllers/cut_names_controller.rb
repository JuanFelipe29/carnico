class CutNamesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cut_name.save
        format.html { redirect_to cut_name_url(@cut_name), notice: "Cut name was successfully created." }
  ...
  def update
    respond_to do |format|
      if @cut_name.update(cut_name_params)
        format.html { redirect_to cut_name_url(@cut_name), notice: "Cut name was successfully updated." }
